...
| F2.09 | Thời hạn: quá hạn, phí, gia hạn | Nhắc mỗi 10' `OrderScheduler.java:15`; phí `OrderService.java:1556-1565`; EXPIRED `:1131-1175`; gia hạn `:292-321`; web hiện EXPIRED + phí quá hạn `frontend/fe/src/components/shared/reporting/report-meta.ts:77-84`, `frontend/fe/src/pages/Admin/orders/detail.tsx` | PARTIAL | Phí quá hạn cộng **sau** khi kiểm tra PAID ⇒ không bao giờ thu |
...
6. Gửi mã cho người nhận qua **cả ba** đường: push in-app nếu SĐT trùng tài khoản, SMS tới SĐT đã nhập, và email nếu người gửi có nhập. Không kênh nào tới nơi ⇒ báo lại người gửi để họ tự chuyển mã. Xem [receiver-pickup-code.md](../01-overview/receiver-pickup-code.md).
